...
public class Grid2_Node1_Intake_ChargingStation extends AutoRoutine{
    private final AutoPath m_Path1 = new AutoPath("paths/1_Grid2_Node1_Intake_ChargingStation.wpilib.json");
    private final AutoPath m_Path2 = new AutoPath("paths/2_Grid2_Node1_Intake_ChargingStation.wpilib.json");
    ...
    public Grid2_Node1_Intake_ChargingStation() {
        super("Grid2_Node1_Intake_ChargingStation");
