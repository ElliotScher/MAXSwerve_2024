...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final double MAX_LINEAR_SPEED_METERS_PER_SECOND =
        4.8; // TODO: TUNE FOR MAX ALLOWED SPEED OF SWERVE
    ...
    public static final double TRACK_WIDTH_METERS =
        Units.inchesToMeters(
            24.5); // TODO: ENTER EMPERICAL MEASUREMENT: distance between wheels in X
    public static final double WHEEL_BASE_METERS =
        Units.inchesToMeters(
            24.5); // TODO: ENTER EMPERICAL MEASUREMENT: distance betweeen wheels in Y

    public static final double DRIVE_BASE_RADIUS_METERS =
        Math.hypot(TRACK_WIDTH_METERS / 2.0, WHEEL_BASE_METERS / 2.0);
    ...
    // TODO: THESE ARE THE CAN IDS OF YOUR ROBOT'S MOTORS - CHANGE THESE TO MATCH WHAT YOU IMAGED
    // YOUR SPARK MAX/FLEX CONTROLLERS WITH
  ...
  public static final class ModuleConstants {
    public static final int DRIVE_PINION_TEETH =
        14; // TODO: THIS IS THE NUMBER OF TEETH ON YOUR DRIVE PINION. THIS WILL CHANGE THE MAX
    // SPEED AND TORQUE OF THE ROBOT.
    public static final boolean TURN_ENCODER_INVERTED = true;

    public static final double DRIVE_MOTOR_FREE_SPEED_RPS =
        MotorConstants.NEO_FREE_SPEED_RPM
            / 60.0; // TODO: CHANGE TO VORTEX CONSTANT IF USING THE NEW VORTEX MOTORS
    public static final double WHEEL_DIAMETER_METERS =
        0.0762; // THIS VALUE MAY CHANGE OVER TIME DUE TO WHEEL WARE, IDEALLY, YOU WANT TO CHANGE
    // YOUR WHEELS BEFORE YOU NEED TO CHANGE THIS VALUE
